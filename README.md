...
```powershell
py -m pip install Pillow lz4 cryptography tkinterdnd2
```

Verify the packages:

```powershell
py -c "from PIL import Image; import lz4.block, cryptography, tkinterdnd2; print('Crystal Legacy Studio requirements are installed.')"
```
